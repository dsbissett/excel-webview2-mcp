...
import {parseArguments} from '../build/src/bin/excel-webview2-mcp-cli-options.js';
...
async function fetchTools() {
  console.log('Connecting to excel-webview2-mcp to fetch tools...');
  ...
  const transport = new StdioClientTransport({
    command: 'node',
    args: [serverPath],
    env: {...process.env, EXCEL_WEBVIEW2_MCP_NO_USAGE_STATISTICS: 'true'},
  });

  const client = new Client(
    {
      name: 'excel-webview2-cli-generator',
      version: '0.1.0',
    },
    {
      capabilities: {},
...
async function generateCli() {
  ...
  const lines: string[] = [];
  lines.push(`// NOTE: do not edit manually. Auto-generated by 'npm run cli:generate'.
