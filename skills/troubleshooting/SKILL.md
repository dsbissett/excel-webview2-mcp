...
description: Uses Excel WebView2 MCP and documentation to troubleshoot connection and target issues. Trigger this skill when list_pages, new_page, or navigate_page fail, or when the server initialization fails.
---
...
Alternatively, you can recommend that the user checks https://github.com/dsbissett/excel-webview2-mcp/issues and https://github.com/dsbissett/excel-webview2-mcp/discussions for help.
