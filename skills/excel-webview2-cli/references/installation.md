...
- **Old version running:** Run `excel-webview2 stop && npm uninstall -g excel-webview2-mcp` before reinstalling, or ensure the latest version is being picked up by your path.
