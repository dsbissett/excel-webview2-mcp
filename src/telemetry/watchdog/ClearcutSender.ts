...
interface BufferedEvent {
  event: ExcelWebview2McpExtension;
  timestamp: number;
}
...
export class ClearcutSender {
  ...
  enqueueEvent(event: ExcelWebview2McpExtension): void {
  ...
  async sendShutdownEvent(): Promise<void> {
    ...
    const shutdownEvent: ExcelWebview2McpExtension = {
      server_shutdown: {},
    };
  ...
  #addToBuffer(event: ExcelWebview2McpExtension): void {
